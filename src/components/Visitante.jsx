...
import style from "../styles/Visitante.module.css";

function Visitante({ jugadores, stats, calcularStats }) {
  ...
  return (
    <div className={style.contenedor}>
      <h2 className={style.titulo}>EQUIPO VISITANTE</h2>
      <div className={style.tablaWrapper}>
        <table className={style.visitante} border="1">
          <thead>
            <tr>
              <th>Jugador</th>
              <th>Min.</th>
